...
// AsyncJson.h
/*
  Async Response to use with ArduinoJson and SAWServer
  Written by Andrew Melvin (SticilFace) with help from me-no-dev and BBlanchon.

  Example of callback in use

   server.on("/json", HTTP_ANY, [](SAWServerRequest * request) {
  ...
  Async Request to use with ArduinoJson and SAWServer
  Written by Arsène von Wyss (avonwyss)

  Example

  AsyncCallbackJsonWebHandler* handler = new AsyncCallbackJsonWebHandler("/rest/endpoint");
  handler->onRequest([](SAWServerRequest *request, JsonVariant &json) {
...
typedef std::function<void(SAWServerRequest *request, JsonVariant &json)> ArJsonRequestHandlerFunction;
